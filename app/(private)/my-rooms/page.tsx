          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-xl font-semibold tracking-tight text-foreground">
              {userLogged.role === "INSTRUCTOR"
                ? "Você não criou nenhuma sala"
                : "Você não está em nenhuma sala"}
            </h2>
            <p className="max-w-sm text-sm text-muted-foreground leading-relaxed">
              {userLogged.role === "INSTRUCTOR"
                ? "Crie uma sala agora mesmo para auxiliar os estudos autônomos dos discentes."
                : "Participe de uma sala para começar seus estudos autônomos sobre um assunto que deseja aprender."}
            </p>
          </div>
