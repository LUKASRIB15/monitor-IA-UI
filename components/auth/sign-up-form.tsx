...
import { useCreateStudentAccount } from "@/hooks/use-create-student-account";

const signUpFormValidationSchema = z
  .object({
    name: z.string().min(5, "O seu nome deve ter no mínimo 5 caracteres."),
...
export function SignupForm({
  ...
  async function handleSignUp(data: SignUpFormData) {
    await createStudentAccount.execute(data);
  }
      ...
      <FieldGroup>
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          <p className="text-sm text-balance text-muted-foreground">
            Complete o formulário abaixo para criar sua conta.
          </p>
        </div>
        <Field>
        ...
        <Field>
          ...
          <FieldDescription className="px-6 text-center">
            Já possui uma conta? <Link href="/sign-in">Acessar</Link>
          </FieldDescription>
        </Field>
      </FieldGroup>
    </form>
